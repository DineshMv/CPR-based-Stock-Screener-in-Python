...
def calculate_pivots():
    ...
    print(f'Shelbot\U0001F607: Calculating Pivot Values...')
    ...
    print(f'Shelbot\U0001F607: Calculating Support Values...')
    ...
    print(f'Shelbot\U0001F607: Calculating Resistance Values...')
    ...
    print(f"Shelbot\U0001F607: Pivot Dataset is downloaded to 'stock_data.csv'")
# calculate_pivots()
