...
df1 = pd.read_csv('../dataset/ticker_data.csv')
...
print('Initialising new columns to prepare Pivot data set....')
...
# df1 = pd.DataFrame(ticker_data.csv)
# df2 = pd.DataFrame(cpr_pivot_data.csv)
